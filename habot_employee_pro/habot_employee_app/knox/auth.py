from habot_employee_app.knox.crypto import hash_token
from habot_employee_app.knox.custom_settings import knox_settings, CONSTANTS
from habot_employee_app.knox.models import AuthToken
from habot_employee_app.knox.signals import token_expired
...
class TokenAuthentication( BaseAuthentication ):
    ...
    def authenticate(self, request):
        # this function used to encode the http header
    ...
    def authenticate_credentials(self, token):
        ...
        msg = {
            'response_code': 400,
            "message": "Your device is logged-in on another device",
            'statusFlag': False,
            'status': 'FAILED',
            'errorDetails': None,
            'data': []
    ...
    def _cleanup_token(self, auth_token):#if token expire delete the token
