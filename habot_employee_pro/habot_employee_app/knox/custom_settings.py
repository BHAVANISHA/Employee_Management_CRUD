from habot_employee_pro.settings import REST_KNOX
...
knox_settings = APISettings(USER_SETTINGS, REST_KNOX, IMPORT_STRINGS)
...
def reload_api_settings(*args, **kwargs):
    ...
    if setting == 'REST_KNOX':
        knox_settings = APISettings(value, REST_KNOX, IMPORT_STRINGS)
